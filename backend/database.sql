...
4	Tipo de usuários	Users Types	groups	2	22	fa-users fa-wrench	
...
SELECT pg_catalog.setval('system.menu_id_seq', 5, true);
...
SELECT pg_catalog.setval('system.users_signin_id_seq', 147, true);
